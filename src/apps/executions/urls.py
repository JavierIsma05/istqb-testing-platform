...
urlpatterns = [
    ...
    path('<int:pk>/review/', execution_review_detail_view, name='detail-review'),
    path('steps/<int:pk>/evidence/', step_evidence_upload_view, name='step-evidence'),
    path('steps/<int:pk>/review/', step_review_detail_view, name='step-review'),
